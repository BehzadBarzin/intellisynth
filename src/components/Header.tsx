...
import { intellisynth } from "../assets";
...
const Header = () => {
  ...
  // ---------------------------------------------------------------------------
  // State to open/close navigation
  ...
  // ---------------------------------------------------------------------------
  const handleClick = () => {
    // If navigation is closed, ignore click
    ...
    >
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        ...
        <a className="block w-[12rem] xl:mr-8" href="#hero">
          <img src={intellisynth} width={190} height={40} alt="intellisynth" />
        </a>
